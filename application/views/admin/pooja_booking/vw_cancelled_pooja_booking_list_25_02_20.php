...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Cancelled Pooja Booking List
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a href="<?php echo base_url(); ?>admin/delete-cancelled-pooja-booking/<?php echo (!empty($value['pk_id']) ? $value['pk_id'] : ''); ?>" onClick="return confirm('Are you sure you want to delete record?')"><button type="button" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></button></a> 
                        </td>
                     </tr>
                       <?php
                  $i++;
