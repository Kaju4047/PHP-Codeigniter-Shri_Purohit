   ...
   <section class="content-header">
      <h1>Upcoming Puja Booking List          
         ...
         <div class="pull-right">
            ...
            <a href="<?php echo base_url(); ?>admin/upcoming-pooja-booking-list?cust_id=<?php echo (!empty($cust_id) ? $cust_id : ''); ?>&&purohit_id=<?php echo (!empty($purohit_id) ? $purohit_id : ''); ?>"><button type="button" class="btn btn-primary">Upcoming</button></a>
            ...
            <div class="box-body no-height">
              <form id="filter"  method='get'  enctype="multipart/form-data"> 
                ...
                <input type="hidden" name="search_term" value="<?php echo!empty($this->input->get('search_term')) ? $this->input->get('search_term') : ''; ?>">
                 <div class="col-md-2 form-group">
                  <button type="submit" class="btn btn-primary filter-btn" onclick="javascript: form.action='<?php echo base_url('admin/upcoming-pooja-booking-list');?>';"><i class="fa fa-filter"></i> Filter</button></div>
                    <div class="col-md-2 form-group">
                  <?php if(!empty($upcomingPoojaDeatails)){?>
                   <button type="submit" class="btn btn-primary filter-btn" onclick="javascript: form.action='<?php echo base_url('admin/pooja-booking-export-to-excel/3');?>';">Export to Excel</button>
                 <?php }?>
                </div>
