                           ...
                           <div class="col-md-12">
                              <!-- <div class="reg-user-img" style="background-image: url('<?php echo base_url(); ?>AdminMedia/images/avatar5.png')">
                               ...
                               <div class="reg-user-img">
                                 <?php $imgdata = !empty($rejectedView[0]['customer_photo']) ? 'upload/customer_profile/' . $rejectedView[0]['customer_photo'] : 'AdminMedia/images/avatar5.png'; ?>
                              ...
                              <table class="usertable">
                                 <tbody>
                                    <tr>
                                       ...
                                       <td width="70%"><?php echo !empty($rejectedView[0]['purohit_name'])?ucfirst($rejectedView[0]['purohit_name']):''; ?></td>
                                    </tr>
                                    <tr>
                                       <th>Mobile No.</th>
                                       <td><?php echo !empty($rejectedView[0]['mobile_no'])?$rejectedView[0]['mobile_no']:''; ?></td>
                                    </tr>
                                    <tr>
                                       <th>Location</th>
                                       <td><?php echo !empty($rejectedView[0]['address'])?$rejectedView[0]['address']:''; ?></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                             <!--  <div class="reg-user-img" style="background-image: url('<?php echo base_url(); ?>AdminMedia/images/avatar-new.png')">
                               ...
                               <div class="reg-user-img">
                                 <?php $imgdata = !empty($rejectedView[0]['upload_profile_image']) ? 'upload/android/registartion/purohit_profile/' . $rejectedView[0]['upload_profile_image'] : 'AdminMedia/images/avatar-new.png'; ?>
                                 <img src="<?php echo base_url(). $imgdata;?>" class="reg-user-img" width="50%">
                              </div>
                           </div>
                           <div style="padding: 5px;background-color: #f1f5ff">
