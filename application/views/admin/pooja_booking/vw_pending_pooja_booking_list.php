   ...
   <section class="content-header">
      ...
      <!--    <div class="pull-right">
          ...
          // die();
           ?>
         <div class="pull-right">
           <a href="<?php echo base_url(); ?>admin/pending-pooja-booking-list?cust_id=<?php echo (!empty($cust_id) ? $cust_id : ''); ?>&&purohit_id=<?php echo (!empty($purohit_id) ? $purohit_id : ''); ?>"><button type="button" class="btn btn-primary">Pending</button></a>
              ...
              <form id="filter"  method='get'  enctype="multipart/form-data"> 
                ...
                <div class="col-md-2 form-group">
                 <!--  <button type="button" class="btn btn-warning filter-btn"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button> -->
                  <button type="submit" class="btn btn-primary filter-btn" onclick="javascript: form.action='<?php echo base_url('admin/pending-pooja-booking-list/1');?>';"><i class="fa fa-filter"></i> Filter</button>
                </div>
                <div class="col-md-2 form-group">
                  <?php if(!empty($pendingPoojaDeatails)){?>
                   <button type="submit" class="btn btn-primary filter-btn" onclick="javascript: form.action='<?php echo base_url('admin/pooja-booking-export-to-excel/1');?>';">Export to Excel</button>
                 <?php }?>
                </div>
             </form>
            </div>
                    ...
                    <?php
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                          ...
                          <?php } 
                          if( in_array('pooja_booking_delete', $privilige)){ ?>
                          <a href="<?php echo base_url(); ?>admin/delete-pending-pooja-booking-list/<?php echo (!empty($value['pk_id']) ? $value['pk_id'] : ''); ?>" onClick="return confirm('Are you sure you want to delete record?')"><button type="button" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></button></a> 
                           <?php }?>
                       </td>
                     <?php }?>
                     </tr>
