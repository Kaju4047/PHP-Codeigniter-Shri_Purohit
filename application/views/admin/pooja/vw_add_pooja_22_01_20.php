            ...
            <div class="box-body">
              ...
              <input type="hidden" name="baseurl" id="baseurl" value="<?php echo base_url(); ?>" class="form-control">
               ...
               <div class="col-md-4 form-group">
                  ...
                  <?php 
                   $imgdata = !empty($edit['pooja_image']) ? 'uploads/pooja/' . $edit['pooja_image'] : 'AdminMedia/images/default.png';
                  ?>
               ...
               <div class="col-md-12 form-group">
                  ...
                  <textarea class="form-control" id="sm-desc" style="resize: none;height: 110px" name="description" placeholder=""><?php echo (!empty($edit['short_description']) ? $edit['short_description'] : ''); ?></textarea>
                                <div for="sm-desc" generated="true" class="error"></div>
               </div>
               <div class="col-md-12 form-group">
                  <label>Long Description</label>
                  <!--<textarea rows="3" class="form-control" id="long_description" name="long_description" style="resize: none;"></textarea>-->
                <textarea class="form-control" id="lg-desc" style="resize: none;height: 110px" name="description" placeholder=""><?php echo (!empty($edit['long_description']) ? $edit['long_description'] : ''); ?></textarea>
                                <div for="lg-desc" generated="true" class="error"></div>
               </div>
               <div class="col-md-12 form-group">
                ...
                <textarea class="form-control" id="editor" style="resize: none;height: 110px" name="description" placeholder=""><?php echo (!empty($edit['silent_feature']) ? $edit['silent_feature'] : ''); ?></textarea>
